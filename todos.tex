...
\item $\square$ Rework Docu
\begin{itemize}
\item Unite Implementation and Documentation part of Documentation
\item Document all features
...
\end{itemize}
\item $\square$ BUG Subproblem counter not reset on newproblem with number
(see NumRech u5)
\begin{itemize}
\item Check if subsubproblem works!
\end{itemize}
\end{itemize}
