...
\lstset{basicstyle=\color{fg}\ttfamily,
  keywordstyle=\color{polynom-blue}\bfseries,
  commentstyle=\color{polynom-green},
  stringstyle=\color{polynom-red}
}
...
\date{\today}
\institute[\LaTeX--Templates]{Institut für \LaTeX--Templates}
